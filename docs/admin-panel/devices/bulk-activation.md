...
If you are transferring a large number of GPS devices from another platform to Navixy, activating each device manually can be a challenge. Instead, you can simply contact [Navixy support](mailto:support@navixy.com) to register hundreds or even thousands of devices with just a single CSV or Excel file.

## Device list template

Before you begin, please ensure that your CSV file contains the following columns in the specified order:
