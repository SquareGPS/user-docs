...
2. **Employee role:** This role is designed for users who require limited access to Admin Panel. Users with the [employee role](access.md#employee-role-with-limited-rights) can perform only specific tasks and have restricted access to certain features and settings. This role is created by sending a request to [Navixy support](mailto:support@navixy.com).
