...
You can set the default time zone, date / time format, and measurement system, as well as enable SMS transliteration. These settings will be used when your users log in to the system for the first time.
