...
To learn more about types of email gateways and how to configure them, see [Email gateway](email-gateway.md).
...
For more information about setting up SMS gateways, see [SMS gateway](sms-gateway.md).
