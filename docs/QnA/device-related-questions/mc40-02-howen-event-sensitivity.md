...
To change sensitivity, log in to the camera via Howen iTools, select either DMS or ADAS events, and then click the specific event you want to configure. There you can adjust:
