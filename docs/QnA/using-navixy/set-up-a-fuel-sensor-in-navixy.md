...
Before reading these instructions, kindly familiarise yourself with our guidance on the fuel management system in Navixy. Also, if you have a Teltonika tracker, kindly review the following guidance before continuing with this article: Configuring Sensors on Teltonika Trackers.

1. First step, go to the Devices and Settings menu section, find your tracker, and select it.
