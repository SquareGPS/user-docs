...
It looks like the tracker operates in the "Static navigation mode". While the device can still connect to cellular networks (GSM), it doesn't update its GPS location in this mode.
