...
Make sure all commands are sent _in order_ as the COREKITSW,0 command is required, and the SERVER,0,**{server}**,47755# command is the required finisher command.
