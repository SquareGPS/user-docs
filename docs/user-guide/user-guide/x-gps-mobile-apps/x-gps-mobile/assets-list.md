...
{% column %}
<figure><img src="../../../.gitbook/assets/image-20250404-102729.png" alt="Events"><figcaption><p>Events</p></figcaption></figure>
{% endcolumn %}
{% endcolumns %}
...
{% column %}
<figure><img src="../../../.gitbook/assets/image-20250404-102815.png" alt="Map"><figcaption><p>Map</p></figcaption></figure>
{% endcolumn %}
{% endcolumns %}

Tap <img src="../../../.gitbook/assets/icon5.png" alt="Map options" data-size="line"> to display the map options menu:

| <img src="../../../.gitbook/assets/Untitled (4).jpg" alt="Places" data-size="original"> | <img src="../../../.gitbook/assets/Untitled (5).jpg" alt="Geofences" data-size="original"> | <img src="../../../.gitbook/assets/Untitled (6).jpg" alt="Map type" data-size="original"> |
| --------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------- |
