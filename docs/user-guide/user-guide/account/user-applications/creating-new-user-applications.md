...
Start by clicking the <img src="../../../.gitbook/assets/chrome_py0qhiu5p8 (2).webp" alt="chrome_py0qhiu5p8.webp" data-size="line"> button in the **User applications** list. In the appeared configuration form, proceed with the following steps:
