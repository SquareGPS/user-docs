...
* **Center** <img src="../../../.gitbook/assets/image-20250403-153008 (1).png" alt="image-20250403-153008.png" data-size="line">: This button allows you to quickly focus on the canvas area that contains actual elements, ensuring that the whole flow is visible. It is especially helpful for large and complex flows, but at the same time offers a handy shortcut to autosize the flowchart to fit the window.
* **Zoom in/out** <img src="../../../.gitbook/assets/image-20250403-153042 (1).png" alt="image-20250403-153042.png" data-size="line">: Common functionality to manage the scale of the flowchart. You can also zoom in or out using your mouse wheel.

## Default flow

<figure><img src="../../../.gitbook/assets/default-flow (1).webp" alt="Default flow configuration showing the Default input and Default output endpoint nodes connected"><figcaption></figcaption></figure>
...
<div align="right"><figure><img src="../../../.gitbook/assets/image-20250403-151042 (1).png" alt="Navixy Default output endpoint node"><figcaption></figcaption></figure></div>
{% endcolumn %}
{% endcolumns %}
...
To access this feature, select the default flow and click <img src="../../../.gitbook/assets/image-20250403-151357 (1).png" alt="image-20250403-151357.png" data-size="line"> button in the top menu.
