...
* Click ![DATA\_ANALYZER.png](<../../../.gitbook/assets/DATA_ANALYZER (2).png>)
{% endhint %}

![Data Analyzer view](../../../.gitbook/assets/Data_Analyzer_big.png)
...
![Top menu bar controls](<../../../.gitbook/assets/Menu_bar (1).png>)
...
{% columns %}
{% column %}
![Adding devices for monitoring](<../../../.gitbook/assets/Devices_list (1).png>)
{% endcolumn %}

{% column %}
![Adding attributes for monitoring](<../../../.gitbook/assets/Attributes_list (1).png>)
{% endcolumn %}
{% endcolumns %}
...
![Table view example](<../../../.gitbook/assets/Table_example (1).png>)
...
![Value timestamp example](<../../../.gitbook/assets/image-20241204-160551 (1).png>)
