...
![Top menu bar controls](<../../../.gitbook/assets/Menu_bar (3) (1).png>)
...
{% columns %}
{% column %}
![Adding devices for monitoring](<../../../.gitbook/assets/Devices_list (3) (1).png>)
{% endcolumn %}

{% column %}
![Adding attributes for monitoring](<../../../.gitbook/assets/Attributes_list (3) (1).png>)
{% endcolumn %}
{% endcolumns %}
...
![Table view example](<../../../.gitbook/assets/Table_example (3) (1).png>)
...
![Value timestamp example](<../../../.gitbook/assets/image-20241204-160551 (3) (1).png>)
