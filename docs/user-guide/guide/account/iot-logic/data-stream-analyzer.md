...
![Top menu bar controls](<../../../.gitbook/assets/Menu_bar (3).png>)
...
{% columns %}
{% column %}
![Adding devices for monitoring](<../../../.gitbook/assets/Devices_list (3).png>)
{% endcolumn %}

{% column %}
![Adding attributes for monitoring](<../../../.gitbook/assets/Attributes_list (3).png>)
{% endcolumn %}
{% endcolumns %}
...
![Table view example](<../../../.gitbook/assets/Table_example (3).png>)
...
![Value timestamp example](<../../../.gitbook/assets/image-20241204-160551 (3).png>)
