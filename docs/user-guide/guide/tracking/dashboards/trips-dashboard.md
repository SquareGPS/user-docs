...
The Trips Dashboard always shows the last 7 days of trip data. There is no date picker, and the window cannot be changed. For trip data over a different period, use the [Trips and parkings report](/docs/user/guide/reports/specific-report-details/trip-report).
