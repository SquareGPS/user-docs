...
<table><thead><tr><th width="102.18182373046875">Icon</th><th>Moving status and description</th></tr></thead><tbody><tr><td><img src="../../../.gitbook/assets/image-20240718-221255 (3) (1).png" alt="image-20240718-221255.png"></td><td><strong>Moving</strong><br>The tracker is moving, and the trip is being recorded.</td></tr><tr><td><img src="../../../.gitbook/assets/image-20240718-221249 (3) (1).png" alt="image-20240718-221249.png"></td><td><strong>Stopped (not parked yet)</strong><br>The object has stopped moving, its speed is zero, but the trip is not yet complete.</td></tr><tr><td><img src="../../../.gitbook/assets/image-20240718-221243 (3) (1).png" alt="image-20240718-221243.png"></td><td><strong>Parked</strong><br>The trip is over, and the object is parked.</td></tr><tr><td><img src="../../../.gitbook/assets/image-20240718-221219 (3) (1).png" alt="image-20240718-221219.png"></td><td><strong>Approximate location ( no GPS signals</strong>, <strong>using LBS)</strong><br>No GPS signal. The location is determined by cellular base stations and/or Wi-Fi access points. Route, parking, and stops aren’t recorded in this status due to low coordinate accuracy.</td></tr></tbody></table>
...
![Change icon option](<../../../.gitbook/assets/Change_icon (1) (1).png>)

1. Go to the **Tracking** module from the main menu.
2. In the **Objects list**, select the object whose icon you want to change.
3. Click <img src="../../../.gitbook/assets/Untitled-20250407-124610 (1) (1).png" alt="Untitled-20250407-124610.png" data-size="line"> to open the menu.
4. Select **Change icon** to open the icon selection window.
5.  Choose a new icon from the available options:

    <div align="left"><img src="../../../.gitbook/assets/image-20240718-222003 (3) (1).png" alt="" width="177"></div>
...
![](<../../../.gitbook/assets/image-20240718-221420 (3) (1).png>)
