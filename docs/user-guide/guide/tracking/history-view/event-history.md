...
{% column %}
![Events list](<../../../.gitbook/assets/image-20240808-192358 (1).png>)
{% endcolumn %}
{% endcolumns %}
...
For more details on setting up and managing these events, refer to [Rules and Notifications](/broken/pages/af4DTfjY1sz82LLjmk4e).
