...
Geofences are virtual perimeters that allow the system to monitor whether an object has crossed the geofence border ("in" or "out"). These events are logged, enabling users to generate geofence reports and [receive alerts](../../events-and-notifications/movement-monitoring/geofence-entrance-or-exit.md). Geofences can also be related to specific [rules for events](/broken/pages/af4DTfjY1sz82LLjmk4e) within particular areas, such as receiving speeding alerts only within a city or along a route.

To access the **Geofences** tool, click <img src="../../../.gitbook/assets/image-20250425-083834 (1) (1).png" alt="image-20250425-083834.png" data-size="line"> in the upper-right corner of the map. Selecting any of the geofences will display the objects currently located within its borders.

![Geofences tool](<../../../.gitbook/assets/image-20240807-002528 (3) (1).png>)
...
![Example: A route geofence is often used in route deviation rules](<../../../.gitbook/assets/image-20240806-235506 (3) (1).png>)
...
Click <img src="../../../.gitbook/assets/image-20250425-083834 (1) (1).png" alt="image-20250425-083834.png" data-size="line"> in the top-right corner of the map.
{% endstep %}

{% step %}
**Select geofence type**

Hover the cursor over the <img src="../../../.gitbook/assets/image-20250325-150554-20250425-083602 (1).png" alt="New geofence" data-size="line"> button and select the geofence you want to create:
...
To edit a geofence, click <img src="../../../.gitbook/assets/Untitled-20250425-103233 (1) (1).png" alt="Untitled-20250425-103233.png" data-size="line"> next to the geofence you want to edit in the **Geofences** tool. When editing a geofence, you can adjust the same fields as during its creation.\
For the description of those fields, see [Creating geofences](geofences.md#creating-geofence).

### Deleting geofences

To delete a geofence, select it and click <img src="../../../.gitbook/assets/image-20250425-104605 (1) (1).png" alt="image-20250425-104605.png" data-size="line"> in the top-right corner next to **Quick search**.
...
To see details about the selected geofence, click <img src="../../../.gitbook/assets/Untitled-20250416-090916 (3) (1).png" alt="Untitled-20250416-090916.png" data-size="line"> next to it.
...
2. Hover the cursor over the ![image-20250425-105021.png](<../../../.gitbook/assets/image-20250425-105021 (1) (1).png>) button and click the **Circle geofences import** button.
...
1. Open the **Geofences** tool.
2. Hover the cursor over the ![image-20250425-105021.png](<../../../.gitbook/assets/image-20250425-105021 (1) (1).png>) button and click the **Geofences import from KML** button.
...
1. Open the **Geofences** tool.
2. Click ![Download geofences](<../../../.gitbook/assets/image-20250425-132255 (1) (1).png>) on the tool panel.
