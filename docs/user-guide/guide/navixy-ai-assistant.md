...
{% hint style="info" %}
To use the assistant from within the Navixy interface, it needs to be added to your account via the [User Applications](account/user-applications/) feature. Contact your service provider if the assistant is not visible in your interface.
{% endhint %}
