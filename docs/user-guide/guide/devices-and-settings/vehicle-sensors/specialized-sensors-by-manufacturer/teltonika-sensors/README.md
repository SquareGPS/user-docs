...
<table data-view="cards"><thead><tr><th>Sensor</th><th>What it does</th><th data-card-target data-type="content-ref">Link</th></tr></thead><tbody><tr><td><strong>BLE Beacons (Teltonika)</strong></td><td>Monitor temperature, magnetic state, and proximity over BLE.</td><td><a href="ble-beacons-teltonika.md">ble-beacons-teltonika.md</a></td></tr><tr><td><strong>BLE fuel level sensors (Teltonika)</strong></td><td>Read fuel level, temperature, and humidity without wiring.</td><td><a href="ble-fuel-level-sensors-teltonika.md">ble-fuel-level-sensors-teltonika.md</a></td></tr></tbody></table>
