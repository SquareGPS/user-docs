...
Tells the device how to determine that the engine is running, based on on-board voltage. A running engine raises system voltage above the battery's resting level.
