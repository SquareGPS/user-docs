...
* **Upload records count**: how many records the device accumulates before sending a batch to the platform. For example, a value of 10 with a 10-second interval means data uploads roughly every 100 seconds.
