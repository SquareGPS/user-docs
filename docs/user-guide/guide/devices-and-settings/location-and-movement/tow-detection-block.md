...
In Navixy, you can configure this function by accessing the **Tow detection** block in the **Devices and settings** module. This panel allows you to adjust the motion sensor sensitivity and specify the time delay before detection begins.
