...
* **API.** You can use the [API call](https://www.navixy.com/docs/navixy-api/user-api/data-warehouse-api/resources/tracker/raw-data) to retrieve parsed GPS data for a specific device. This call provides a list of GPS points and other sensor data directly from the Navixy database, which you can use for various purposes.
...
* **Raw data export in UI.** You can use the [Raw data](save-iot-data-to-csv-file/) block in Devices and Settings section for extracting devices data in a conviniant CSV format.
