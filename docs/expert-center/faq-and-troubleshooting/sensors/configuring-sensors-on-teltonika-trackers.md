...
![](attachments/image-20240819-064327.png)
...
![](attachments/image-20240819-065046.png)

### 2. Open configurator

If you are already familiar with using a Teltonika configurator, you can skip this and proceed to the 3d step.

Before you open the configurator, you can connect the device to the PC or create an empty preset (configuration) without connecting the device to the configurator. If you don't have the device on hand, you can use FOTA and upload the configuration later using FOTA, or in a few steps, you will see how to configure the device remotely using Navixy [AirConsole](https://app.gitbook.com/s/KdgeXg71LpaDrwexQYwp/devices/air-console). Either way, you can create a new configuration or open an existing one. The main step at this point is to open the configurator interface as it is needed for whatever plan you have regarding updating the device configuration.

![](attachments/image-20240819-070024.png)

![](attachments/image-20240819-070149.png)

![](attachments/image-20240819-070500.png)
...
![](attachments/image-20240819-071454.png)
...
![](attachments/image-20240819-082641.png)
...
![](attachments/image-20240819-083631.png)
...
![](attachments/image-20240819-084026.png)
...
![](attachments/image-20240819-084430.png)
...
![](attachments/image-20240819-084654.png)
...
![](attachments/image-20240819-091113.png)
...
![](attachments/image-20240819-091443.png)

Operand Parameter ID 50081, values - see the following table:

![](attachments/image-20240819-090916.png)
...
![](attachments/image-20240819-091750.png)
...
![](attachments/image-20240819-080145.png)
...
![](attachments/image-20240819-082053.png)
...
![](attachments/image-20240819-075728.png)
