...
- [Types of fuel sensors](#types-of-fuel-sensors)
  - [Float fuel sensor](#float-fuel-sensor)
  - [Capacitive fuel sensor](#capacitive-fuel-sensor)
  - [Ultrasonic fuel sensor](#ultrasonic-fuel-sensor)
- [How to choose the right fuel sensor](#how-to-choose-the-right-fuel-sensor)
  - [Tank dimensions](#tank-dimensions)
  - [Multiple sensors on one vehicle](#multiple-sensors-on-one-vehicle)
  - [Fuel sensor outputs](#fuel-sensor-outputs)
- [Leading fuel sensor manufacturers](#leading-fuel-sensor-manufacturers)
  - [Omnicomm (Russia)](#omnicomm-russia)
  - [Technoton (Belarus)](#technoton-belarus)
  - [Siensor (China)](#siensor-china)
  - [Escort (Russia)](#escort-russia)
...
*However, this technology has a few pitfalls.* First of all, the installation process is typically difficult and requires a few items:
...
|     |     |     |
| --- | --- | --- |
| ![Omnicomm LLS 4 Digital fuel sensor](https://www.navixy.com/wp-content/uploads/2019/05/LLS4-fuel-sensor-600x250.png) | LLS 4 | Digital fuel sensor  <br>Specification: [Omnicomm-sensors](https://www.navixy.com/wp-content/uploads/2019/05/omnicomm-sensors.pdf) |
| ![Omnicomm LLS-AF 4 Frequency-analogue fuel sensor](https://www.navixy.com/wp-content/uploads/2019/05/LLS-AF4-fuel-sensor-600x250.png) | LLS-AF 4 | Frequency-analogue fuel sensor  <br>Specification: [Omnicomm-sensors](https://www.navixy.com/wp-content/uploads/2019/05/omnicomm-sensors.pdf) |
| ![Omnicomm LLS 20230 Digital fuel sensor in an explosion-proof variation](https://www.navixy.com/wp-content/uploads/2019/05/LLS-20230-fuel-sensor-600x250.png) | LLS 20230 | Digital fuel sensor in an explosion-proof variation  <br>Specification: [Omnicomm-sensors](https://www.navixy.com/wp-content/uploads/2019/05/omnicomm-sensors.pdf) |
...
|     |     |     |
| --- | --- | --- |
| ![](https://www.navixy.com/wp-content/uploads/2019/05/DUT-E-fuel-sensor-150x150.png) | DUT-E | Digital / Frequency-analogue/CAN-like fuel sensors. Any fuel sensor can come with one of the mentioned outputs  <br>Specification: [Technoton-sensors](https://www.navixy.com/wp-content/uploads/2019/05/technoton-sensors.pdf) |
| ![Technoton DUT-E 2Bio Fuel sensor with automatic detection of fuel brand change](https://www.navixy.com/wp-content/uploads/2019/05/DUT-E-2Bio-fuel-sensor-150x150.png) | DUT-E 2Bio | Fuel sensor with automatic detection of fuel brand change (e.g. summer/ winter diesel fuel)  <br>Specification: [Technoton-sensors](https://www.navixy.com/wp-content/uploads/2019/05/technoton-sensors.pdf) |
...
|     |     |     |
| --- | --- | --- |
| ![Siensor D10X Digital fuel sensor](https://www.navixy.com/wp-content/uploads/2019/05/D10X-fuel-sensor-150x150.png) | D10X | Digital fuel sensor  <br>Specification: [Siensor-sensors](https://www.navixy.com/wp-content/uploads/2019/05/siensor-sensors.pdf) |
| ![Siensor AF10X Analogue fuel sensor](https://www.navixy.com/wp-content/uploads/2019/05/AF10X-fuel-sensor-150x150.png) | AF10X | Analogue fuel sensor  <br>Specification: [Siensor-sensors](https://www.navixy.com/wp-content/uploads/2019/05/siensor-sensors.pdf) |
...
|     |     |     |
| --- | --- | --- |
| ![Escort TD-BLE Wireless fuel level sensor](https://www.navixy.com/wp-content/uploads/2019/05/TD-BLE-fuel-sensor-600x498.png) | TD-BLE | Wireless fuel level sensor  <br>Specification: [Escort-sensor](https://www.navixy.com/wp-content/uploads/2019/05/escort-sensor.pdf) |
| ![Escort TD-150 Fuel sensor with multiple output signals](https://www.navixy.com/wp-content/uploads/2019/05/Escort-TD-150-fuel-sensor-600x498.png) | Escort TD-150 | Fuel sensor with multiple output signals: RS-485, analogue output, frequency output  <br>Specification: [Escort-sensor](https://www.navixy.com/wp-content/uploads/2019/05/escort-sensor.pdf) |