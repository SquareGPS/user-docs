...
[Proceso a](../inicio-rpido/activar-el-dispositivo-gps.md)[utom](../../../../wiki/pages/createpage.action)[á](../inicio-rpido/activar-el-dispositivo-gps.md)[tic](../../../../wiki/pages/createpage.action)[o](../inicio-rpido/activar-el-dispositivo-gps.md) [de activa](../../../../wiki/pages/createpage.action)[c](../inicio-rpido/activar-el-dispositivo-gps.md)[i](../../../../wiki/pages/createpage.action)[ó](../inicio-rpido/activar-el-dispositivo-gps.md)[n](../../../../wiki/pages/createpage.action) [d](../inicio-rpido/activar-el-dispositivo-gps.md)[e](../../../../wiki/pages/createpage.action)[l di](../inicio-rpido/activar-el-dispositivo-gps.md)[s](../../../../wiki/pages/createpage.action)[po](../inicio-rpido/activar-el-dispositivo-gps.md)[s](../../../../wiki/pages/createpage.action)[itivo](../inicio-rpido/activar-el-dispositivo-gps.md) requiere introducir el número de teléfono de una tarjeta SIM, pero las tarjetas SIM para comunicación M2M pueden no tenerlo. En este caso, [configurar manualmente el dispositivo](https://squaregps.atlassian.net/wiki/spaces/USERDOCSOLD/pages/2909016770/Manual+device+activation) e introduzca el IMEI del dispositivo (o cualquier conjunto arbitrario de dígitos) como número de teléfono en el cuadro de diálogo de activación. Como alternativa, ponte en contacto con tu proveedor de servicios para solicitar la integración con la plataforma MVNO para habilitar la comunicación mediante ICCID.
