...
El nodo **Iniciar Atributo** en IoT Logic admite una amplia gama de cálculos a través de [Navixy IoT Logic Expression Language](https://squaregps.atlassian.net/wiki/spaces/NAV/pages/3107553932/Navixy+IoT+Logic+Expression+Language?atlOrigin=eyJpIjoiY2VjZWNjNjJhNmZhNDcyMDg1NzJlNTY0MWVkMGIxMjciLCJwIjoiYyJ9). Esta guía proporciona ejemplos prácticos de cálculos comunes para ayudarle a extraer el máximo valor de sus datos IoT.
