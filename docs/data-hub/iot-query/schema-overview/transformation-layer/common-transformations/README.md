...
<table><thead><tr><th width="148">Transformation</th><th width="266">Table</th><th>Description</th></tr></thead><tbody><tr><td><a href="tracks.md">Tracks</a></td><td><code>processed_common_data.tracks</code></td><td>Vehicle trips derived from raw telematics data, including start and end times, distance, speed statistics, and zone detection.</td></tr></tbody></table>

## Next steps

* [**Tracks**](tracks.md): Output schema, algorithm description, customization options, and workflow template download.
